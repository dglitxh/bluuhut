      ...
      <div className="max-w-screen-xl mx-auto container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12">
          <div className="md:col-span-4 p-10">
            ...
            <h3 className="text-2xl sm:text-2xl leading-normal font-semibold ">
            ...
            <FontAwesomeIcon icon={faEnvelope} />
              <span className='text-sm ml-2'><a href="mailto:bluehutsolutions@gmail.com">bluehutsolutions@gmail.com</a></span>
            <div className="flex items-center mt-5">
              <span className="text-sm"></span>
            </div>
          </div>
