        ...
        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-12 md:grid-cols-2 xl:grid-cols-3">
          {serviceData.map((service, index) => (
            <div key={index} className="p-8 space-y-3 border-2 border-primary dark:border-primary rounded-xl">
              ...
              <a href="#" className="inline-flex p-2 text-primary capitalize transition-colors duration-200 transform bg-primary rounded-full dark:bg-primary dark:text-white hover:underline hover:text-blue-600 dark:hover:text-blue-500">
